...
the screen-shot and answered questions).
    ...
    for idx1 in range(len(string1)):
        ...
        for idx2 in range(len(string2)):
            ...
            if string1[idx1] == string2[idx2]:
                ...
                while not (idx1 + this_match_count > len(string1)-1 or idx2
                           + this_match_count > len(string2)-1):
                    if string1[idx1 + this_match_count] == string2[idx2
                                                                   + this_match_count]:
                        this_match_count += 1
                    else:
                        break
