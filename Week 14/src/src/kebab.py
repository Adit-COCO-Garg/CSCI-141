...
from skewer import skewer_create, skewer_close, skewer_add, skewer_front, \
    skewer_remove, skewer_has, skewer_size, skewer_capacity, \
    skewer_string_em, skewer_calories, skewer_vegan
...
def kebab_usage():
    ...
    print("calories - finds calories on the current skewer")
    ...
    print("vegan - determines if the skewer is vegan")
...
def kebab_calories(kebab, args):
    """
    prints the total calories of everything on the skewer
    :param kebab: kebab (Kebab): this kebab
    :param args: IGNORED
    :return: None
    """
    try:
...
def kebab_vegan(kebab, args):
    """
    prints if everything on the skewer is vegan or not
    :param kebab: kebab: kebab (Kebab): this kebab
    :param args: args: IGNORED
    :return: None
    """
    try:
        print(skewer_vegan(kebab.skewer))
    except SkewerException as e:
        print(e)
